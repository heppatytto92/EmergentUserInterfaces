...
// The output format is "Bool(pressure), Bool(movement), Int(position)", for example, "true, false, 5"
...
int READ_Gyro()
{
  ...
  //
  // Need to write some conditions to judge which is the current position of the dice
  //
